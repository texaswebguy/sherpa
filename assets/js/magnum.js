...
Sherpa.ready("sherpaGlobalEvents", function(){
	...
	**********************************************************************************/
	...
	function initCopyHTMLButtons(){
		_.each($('.prettyprint'),function(snippet){
			$(snippet).before('<div class="copyHTML btn btn-mini pull-right">Copy HTML</div>')
		});
		$('.copyHTML').click(function(event){
			event.preventDefault();
		    var srcObj  = $(event.currentTarget).next()[0];
		    ...
		    rangeObj.commonAncestorContainer.innerText.execCommand("copy")
		    alert('Your HTML has been copied\n\r\n\rpress Ctrl+V to paste');
		    console.log(rangeObj.commonAncestorContainer.innerText)
		});
