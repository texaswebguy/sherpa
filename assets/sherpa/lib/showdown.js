//
// Sherpa.Showdown.js -- A javascript port of Showdown.
//
// Copyright (c) 2007 John Fraser.
//
// Original Showdown Copyright (c) 2004-2005 John Gruber
...
// of the Perl version of Showdown.
//
// This is not a normal parser design; it's basically just a
// series of string substitutions.  It's hard to read and
// maintain this way,  but keeping Sherpa.Markdown close to the original
...
//
//
// Modified to be within the Sherpa.Markdown namespace//

// Sherpa.Markdown usage:
//
//   var text = "Markdown *rocks*.";
//
//   var converter = new Sherpa.Markdown.converter();
...
Sherpa.Markdown = {
    extensions: {}
}, forEach = Sherpa.Markdown.forEach = function (a, b) {
...
Sherpa.Markdown.converter = function (a) {
    var b, c, d, e = 0,
        f = [],
        g = [];
    if (typeof module != "undefind" && typeof exports != "undefined" && typeof require != "undefind") {
        ...
        if (h) {
            ...
            Sherpa.Markdown.forEach(i, function (a) {
                var b = stdExtName(a);
                Sherpa.Markdown.extensions[b] = require("./extensions/" + a)
            })
        }
    }
    this.makeHtml = function (a) {
        return b = {}, c = {}, d = [], a = a.replace(/~/g, "~T"), a = a.replace(/\$/g, "~D"), a = a.replace(/\r\n/g, "\n"), a = a.replace(/\r/g, "\n"), a = "\n\n" + a + "\n\n", a = M(a), a = a.replace(/^[ \t]+$/mg, ""), Sherpa.Markdown.forEach(f, function (b) {
            a = k(b, a)
        }), a = z(a), a = m(a), a = l(a), a = o(a), a = K(a), a = a.replace(/~D/g, "$$"), a = a.replace(/~T/g, "~"), Sherpa.Markdown.forEach(g, function (b) {
            a = k(b, a)
        }), a
    };
    if (a && a.extensions) {
        var j = this;
        Sherpa.Markdown.forEach(a.extensions, function (a) {
            typeof a == "string" && (a = Sherpa.Markdown.extensions[stdExtName(a)]);
            if (typeof a != "function") throw "Extension '" + a + "' could not be loaded.  It was either not found or is not a valid extension.";
            Sherpa.Markdown.forEach(a(j), function (a) {
